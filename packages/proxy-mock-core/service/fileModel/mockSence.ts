...
export async function updateSence(
  mockDataFileUrl: string,
  fileInfo: FileListItem,
  senceOptions: SenceOptions,
) {
...
export async function deleteSence(
  mockDataFileUrl: string,
  fileInfo: FileListItem,
  senceName: string,
) {
...
export async function selectSence(
  mockDataFileUrl: string,
  fileInfo: FileListItem,
  senceName: string,
) {
...
export async function getSenceDetail(
  mockDataFileUrl: string,
  fileInfo: FileListItem,
  senceName: string,
) {
